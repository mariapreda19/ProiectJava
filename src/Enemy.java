...
public class Enemy {
    ...
    private String sprite = "../assets/enemy1.png";
    ...
    public Enemy(int positionX, int positionY, String sprite) {
        this.positionX = positionX;
        this.positionY = positionY;
        this.sprite = sprite;
    }
    ...
    public static void drawEnemies(Graphics g, Enemy enemy) {
        int cellSize = 40;
        try {
            ImageIcon icon = new ImageIcon(Player.class.getResource(enemy.sprite));
